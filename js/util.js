...
const menuMap = new Map([
    ...
    ["motive",
        `<h2>Motive</h2>
        <h3>My Own Struggles with DNA</h3>
        <p>When I first learned about DNA, I remember being really confused. Everything was taught to me using 2D diagrams, and then my teacher suddenly pulled up a 3D youtube video about DNA replication which didn’t resemble the 2D diagrams at all! I found the diagrams which show the molecular structure of DNA overwhelming and super difficult to understand. Although I could understand the basics (DNA is made of base pairs, it carries genetic information, there are three components in a nucleotide), I couldn’t visualize the 3D form of DNA in my head (the only image I could conjure was a helical shape with ladder rings, which was <b>not</b> a picture that had the molecular structure in mind). I didn’t get how all the pieces of DNA worked together in 3D space, and how all those pieces somehow became a ribbon-like helical shape.</p>
        <h3>The Problem with Flat Diagrams</h3>
        <p>Most students are introduced to DNA through a series of 2D diagrams. These often break down the molecule into its parts (phosphate, sugar, base pairs) and show them separately. Sometimes they’re simplified for clarity, and sometimes they’re drawn at odd angles to fit on a page. While these diagrams can be useful, they require students to do a lot of mental work to imagine how everything fits together in real space. However, this spacial understanding is crucial in grasping the link between DNA's form and its function.</p>
        <h3>Hopefully This Website Kind of Helps.</h3>
